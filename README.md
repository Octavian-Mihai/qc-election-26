...
- **Candidats** — gabarit complet (12 champs), en deux modes de consultation : *par parti* (filtre CAQ/PCQ/PLQ/PQ/QS) ou *par circonscription* (38 circonscriptions couvertes pour l'instant, dont les régions complètes de la Mauricie, de Laval, de Chaudière-Appalaches, de l'Estrie et de la Capitale-Nationale). Profils complets et sourcés pour les 6 chefs/coporte-parole de parti (incluant Sol Zanetti, coporte-parole de QS, candidat dans Jean-Lesage) ; nom + circonscription confirmés pour les 184 autres candidat·e·s (biographie documentée quand l'information publique le permettait) ; gabarit vide pour les 89 autres circonscriptions.
...
- Profils de candidats pour les 89 circonscriptions restantes, région par région (voir l'ordre dans « Statut » ci-dessus) — au total, les 5 partis dans les 127 circonscriptions du Québec (confirmé via Wikipédia « Liste des circonscriptions provinciales du Québec par région » et Le Québec Vote).
