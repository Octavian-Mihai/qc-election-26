...
- **Candidats** — gabarit complet (12 champs), en deux modes de consultation : *par parti* (filtre CAQ/PCQ/PLQ/PQ/QS) ou *par circonscription* (27 circonscriptions couvertes pour l'instant, dont les régions complètes de la Mauricie, de Laval, de Chaudière-Appalaches et de l'Estrie). Profils complets et sourcés pour les 5 chefs de parti ; nom + circonscription confirmés pour les 130 autres candidat·e·s (biographie documentée quand l'information publique le permettait) ; gabarit vide pour les 100 autres circonscriptions.
...
- Profils de candidats pour les 100 circonscriptions restantes, région par région (voir l'ordre dans « Statut » ci-dessus) — au total, les 5 partis dans les 127 circonscriptions du Québec (confirmé via Wikipédia « Liste des circonscriptions provinciales du Québec par région » et Le Québec Vote).
