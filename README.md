...
**Positions de partis documentées et sourcées. Candidats : 510 personnes confirmées dans 102 circonscriptions (5 chefs + adversaires + Mauricie, Laval, Chaudière-Appalaches, Estrie, Capitale-Nationale, Centre-du-Québec, Outaouais, Saguenay-Lac-Saint-Jean, Bas-Saint-Laurent/Gaspésie–Îles-de-la-Madeleine, Abitibi-Témiscamingue/Côte-Nord/Nord-du-Québec, Laurentides, Lanaudière et Montérégie complètes) ; gabarit vide pour le reste (Montréal).** Expansion en cours, région par région, dans l'ordre : Mauricie ✅ → Laval ✅ → Chaudière-Appalaches ✅ → Estrie ✅ → Capitale-Nationale ✅ → Centre-du-Québec ✅ → Outaouais ✅ → Saguenay-Lac-Saint-Jean ✅ → Bas-Saint-Laurent/Gaspésie–Îles-de-la-Madeleine ✅ → Abitibi-Témiscamingue/Côte-Nord/Nord-du-Québec ✅ → Laurentides ✅ → Lanaudière ✅ → Montérégie ✅ → Montréal (dernière région restante). Les six dimensions, les couches analytiques et l'indice « Québec d'abord » sont codés pour les 5 partis à partir de la couverture de la campagne, avec une source citée sous chaque position. Voir « Sources et méthode » ci-dessous.
...
- **Candidats** — gabarit complet (12 champs), en deux modes de consultation : *par parti* (filtre CAQ/PCQ/PLQ/PQ/QS) ou *par circonscription* (102 circonscriptions couvertes pour l'instant, dont les régions complètes de la Mauricie, de Laval, de Chaudière-Appalaches, de l'Estrie, de la Capitale-Nationale, du Centre-du-Québec, de l'Outaouais, du Saguenay-Lac-Saint-Jean, du Bas-Saint-Laurent/Gaspésie–Îles-de-la-Madeleine, de l'Abitibi-Témiscamingue/Côte-Nord/Nord-du-Québec, des Laurentides, de Lanaudière et de la Montérégie). Profils complets et sourcés pour les 6 chefs/coporte-parole de parti (incluant Sol Zanetti, coporte-parole de QS, candidat dans Jean-Lesage) ; nom + circonscription confirmés pour les 504 autres candidat·e·s (biographie documentée quand l'information publique le permettait) ; gabarit vide pour les 25 circonscriptions de Montréal, la dernière région restante.
...
- Profils de candidats pour les 25 circonscriptions de Montréal, la dernière région restante (voir l'ordre dans « Statut » ci-dessus) — au total, les 5 partis dans les 127 circonscriptions du Québec (confirmé via Wikipédia « Liste des circonscriptions provinciales du Québec par région » et Le Québec Vote).
